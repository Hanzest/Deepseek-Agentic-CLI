...
const HYPERPARAMETERS = {
    ...
    system_prompt:
        `
            ...
            3. **Tertiary:** Domain-specific \`SKILL.md\` files in \`Deepseek-Agentic-CLI/docs/skills/\`
            ...
            2. Scan \`Deepseek-Agentic-CLI/docs/skills/\` for relevant SKILL.md files using these specific tool steps:
