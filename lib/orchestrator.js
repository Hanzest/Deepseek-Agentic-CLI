...
const SessionContext = {
    ...
    condensationAttemptedThisTurn: false, // circuit-breaker for context condenser
...
async function multiTurnLoop(model_name) {
    ...
    while (!stop) {
        ...
        if (
            ...
            !SessionContext.condensationAttemptedThisTurn
        ) {
            ...
            if (result) {
                ...
                SessionContext.condensationAttemptedThisTurn = true;
        ...
        // Reset the condensation circuit breaker for this new turn
        SessionContext.condensationAttemptedThisTurn = false;
