...
const PRICING = {
    ...
    "gemini-3-flash-preview":  { input: 0.125, output: 0.75 },
};
...
async function callModel(
    ...
    // Gemini: reasoning_effort = "minimal" | "low" | "medium" | "high"
    if (extra_body?.reasoning_effort) {
        kwargs.reasoning_effort = extra_body.reasoning_effort;
    }
