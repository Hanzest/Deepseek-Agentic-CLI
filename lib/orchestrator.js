...
const HYPERPARAMETERS = {
    ...
    system_prompt:
        `
            ...
            **Plan First:** In Plan Mode, create a markdown artifacts/plan-orchestrator-{plan name}.md for the plan.
            ...
            - Changes Summary: A table for list of files to be created,
            modified, or deleted, with a brief description of the change for each. Reference structural
            landmarks (e.g., function names), not line numbers.
            - Task Delegation: A list of any sub-tasks that can be delegated to
