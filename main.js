...
// ---------------------------------------------------------------------------
// Path & environment setup (mirrors Python's _SCRIPT_DIR + os.chdir)
// ---------------------------------------------------------------------------
const __filename = fileURLToPath(import.meta.url);
const __dirname = path.dirname(__filename);

// Change to the script's directory so all relative tool paths resolve
// against the project root, regardless of where the user invoked Node from.
...
// ---------------------------------------------------------------------------
// Tool registry -- mirrors Python's TOOL_REGISTRY
// ---------------------------------------------------------------------------
const TOOL_REGISTRY = {
...
async function printStreamResponse(stream) {
  ...
  // Convert tool_calls dict to array for the OpenAI messages array
...
async function callModel(
  ...
  // In JS SDK, thinking and reasoning_effort are top-level params
